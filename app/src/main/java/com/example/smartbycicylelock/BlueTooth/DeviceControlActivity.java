...
import com.example.smartbycicylelock.activity.Fuction;
...
public class DeviceControlActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DBOpenHelper(this, DATABASENAME, null, VERSION);
            // 0314815894
        nextintent = (Button)findViewById(R.id.next_intent);
        nextintent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DeviceControlActivity.this, Fuction.class);
        ...
        lockbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                lockcharacteristic = mGattCharacteristics.get(2).get(0);
                byte[] data = {0};
                mBluetoothLeService.writeCharacteristic(lockcharacteristic,data);
            }
        });
        // 잠금 버튼
        lockbutton2 = (Button)findViewById(R.id.lockButton2);
        lockbutton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                lockcharacteristic = mGattCharacteristics.get(2).get(0);
                byte[] data = {1};
